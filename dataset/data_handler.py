...
def get_dataloaders(data_handler, ds_train, ds_train_clean, ds_query, ds_db):
    ...
    :param ds_train: class of train dataset (full)
    :param ds_train_clean: class of train clean dataset
    ...
    return dataloader_train, dataloader_train_clean, dataloader_q, dataloader_db
